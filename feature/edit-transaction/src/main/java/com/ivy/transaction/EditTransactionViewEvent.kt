...
sealed interface EditTransactionViewEvent {
    ...
    data object StartSpeechRecognition : EditTransactionViewEvent
    data class OnSpeechRecognitionResult(val result: SpeechRecognitionResult) : EditTransactionViewEvent
