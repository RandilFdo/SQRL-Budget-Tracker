...
import com.ivy.ui.R
import com.ivy.ui.component.SquirrelMascot
import com.ivy.ui.component.SquirrelPose
...
fun BoxWithConstraintsScope.OnboardingSplashLogin(
    ...
    // Duolingo-style splash screen with orange background
    if (onboardingState == OnboardingState.SPLASH) {
        ...
        Box(
            modifier = Modifier
                .fillMaxSize()
                .background(Color(0xFFFF9500)) // Orange background like Duolingo
                .systemBarsPadding()
            ...
            // Center the transparent logo
            Image(
                painter = painterResource(id = R.drawable.sqrl_logo_transparent),
                contentDescription = "SQRL Logo",
                modifier = Modifier
                    .size(200.dp)
            ...
            // App name at bottom like Duolingo
            Text(
                text = "SQRL",
