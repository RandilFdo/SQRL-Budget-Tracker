...
import com.ivy.design.system.SqrlMaterial3Theme
...
class RootActivity : AppCompatActivity(), RootScreen {
    ...
    fun requestMicrophonePermission() {
        PermissionRequestHandler.requestRecordAudioPermission(this)
    }
    ...
    override fun onRequestPermissionsResult(
        ...
        if (PermissionRequestHandler.isPermissionGranted(requestCode, permissions, grantResults)) {
            // Permission granted - voice input feature is now available
            Toast.makeText(this, "Voice input feature enabled!", Toast.LENGTH_SHORT).show()
        } else {
            // Permission denied - show message about voice input being unavailable
            Toast.makeText(this, "Voice input feature requires microphone permission", Toast.LENGTH_LONG).show()
        }
    }
}
